...
class IndicesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create index" do
    assert_difference("Index.count") do
      post indices_url, params: { index: { body: @index.body, create: @index.create, new: @index.new } }
    end
  ...
  test "should update index" do
    patch index_url(@index), params: { index: { body: @index.body, create: @index.create, new: @index.new } }
